...
def main():
    ...
    # decision_tree_features = symptoms_features
    ...
    process.plot_confusion_matrix(y_test_symptoms, nb_predictions, model_name="Naive Bayes (objawy)")
    ...
    process.plot_confusion_matrix(y_test_symptoms, nb_flat_prior_predictions, model_name="Naive Bayes (objawy, flat prior)")
    ...
    # process.plot_confusion_matrix(y_test, tree_predictions, classes=np.unique(y))
    ...
    process.plot_confusion_matrix(y_test, rf_predictions, model_name="Random Forest")
    ...
    # process.plot_confusion_matrix(y_test, rf_oversampling_predictions, model_name="Random Forest (oversampling)")
